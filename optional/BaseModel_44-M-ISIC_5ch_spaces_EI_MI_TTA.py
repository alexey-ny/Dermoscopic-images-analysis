...
plot_mean_ROC(test_set_loc2.labels, test_set_loc2.predictions, channels, model_descr = f'{nets_names[params["EFF_NETS"]]}-full-ISIC', to_dir = f'{model_logs}/{save_name}_ROC_PR_plots', channels_first=False)
plot_mean_PR(test_set_loc2.labels, test_set_loc2.predictions, channels, model_descr = f'{nets_names[params["EFF_NETS"]]}-full-ISIC', to_dir = f'{model_logs}/{save_name}_ROC_PR_plots', channels_first=False)
