...
mean_metrics_cols = ['date', 'model', 'image_size', 'batch_size', 'channel', 'test_set','roc_auc', 'pr_auc', 'f1', 'precision', 'recall', 'uuid']
...
for fold, (idxT, idxV) in enumerate(skf.split(train_IP_set)):
    ...
    #     print_log(f'Skipped fold {fold}', [main_logger])
    #     continue
...
for n_ch, ch in enumerate(channels):
    df_mean_metrics_temp_loc.loc[ch] = [datetime_now, nets_names[params["EFF_NETS"]], params["IMG_SIZES"], params["BATCH_SIZES"], 
                                        ...
                                        test_set_loc.precisions_mean[ch][0], test_set_loc.recalls_mean[ch][0], cur_uuid]
    df_mean_metrics_temp_NoL.loc[ch] = [datetime_now, nets_names[params["EFF_NETS"]], params["IMG_SIZES"], params["BATCH_SIZES"], 
                                        ...
                                        test_set_NoL.precisions_mean[ch][0], test_set_NoL.recalls_mean[ch][0], cur_uuid]
