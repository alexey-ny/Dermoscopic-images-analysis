...
main_logger = myLogger('main', f"{model_logs}{datetime.now().strftime('%Y%m%d')}-ensemble.log")
...
# valid_list_IDs = df_test.DDI_file
# valid_list_IDs = list(df_test.isic_id)
...
# n_models = len(models_dirs[:2])
# i = 6
# for i in range(2, 4):
# for i in range(12, n_models):
